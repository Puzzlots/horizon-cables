...
public class NonPortableStorage extends AbstractDataStorageDevice {

    public static final Identifier ID = Identifier.of(HorizonCommon.NAMESPACE, "non-portable-storage");

    public static void register() {
        HorizonRegistries.PC_COMPONENT_REGISTRY.store(ID, NonPortableStorage::new);
    }

    private int size;

    public NonPortableStorage() {
    }

    public NonPortableStorage(int size) {
        this.size = size;
    }
    ...
    public static void write(NonPortableStorage device, int offset, byte[] bytes) throws SizeLimitExceededException {
