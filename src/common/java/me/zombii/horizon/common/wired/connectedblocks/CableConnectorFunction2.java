...
public class CableConnectorFunction2 implements ISidedBlockConnector.ConnectorFunction {
    ...
    public CableConnectorFunction2(
    ...
    public boolean canConnect(BlockState state, Direction direction, BlockState target) {
        ...
        if (!(modBlock instanceof INetworkedBlock networkedBlock2)) return false;

        return networkedBlock2.canConnect(target, direction.getOpposite(), state);
    }
