...
public class INandGateBlock implements IModBlock {

    public static final Identifier ID = Identifier.of(HorizonCommon.NAMESPACE, "i-nand-gate-block");

    private final BlockGenerator blockGenerator;
    private final BlockEventGenerator eventGenerator;

    public INandGateBlock() {
        ...
        eventGenerator = new BlockEventGenerator(
                ...
                Identifier.of("horizon", "inand-gate-block-events")
        );
...
//        this.modelGenerator.getGroup("base").cuboids.add(collisionCube);
        ...
        defaultProperties.modelId = "horizon:imcables/gates/nand-gate.json";
