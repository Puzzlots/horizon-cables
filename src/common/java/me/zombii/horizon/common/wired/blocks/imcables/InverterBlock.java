...
public class InverterBlock implements IEnergyBlock {

    public static final Identifier ID = Identifier.of(HorizonCommon.NAMESPACE, "inverter");
    ...
    public InverterBlock() {
        ...
        eventGenerator = new BlockEventGenerator(
                ...
                Identifier.of("horizon", "inverter-block-events")
        );
...
//        this.modelGenerator.getGroup("base").cuboids.add(collisionCube);
    ...
    public void onPlace(BlockEventArgs args) {
        ...
        AbstractNode forwardNode = network.getNode(
        ...
        if (!(forwardNode instanceof EnergyNode eNode)) return;
    ...
    public AbstractNode createNode(AbstractNetwork network, IReadBlockPosition pos, BlockState state) {
        return new EnergyNodeInverter(network, pos, state, this);
    }
