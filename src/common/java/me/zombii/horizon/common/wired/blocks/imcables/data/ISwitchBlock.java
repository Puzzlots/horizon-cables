...
public class ISwitchBlock implements IModBlock {

    public static final Identifier ID = Identifier.of(HorizonCommon.NAMESPACE, "i-switch-block");
    ...
    public ISwitchBlock() {
        ...
        this.blockGenerator.setBlockEntity(Identifier.of(SwitchBE.ID));
        ...
        eventGenerator = new BlockEventGenerator(
                ...
                Identifier.of("horizon", "iswitch-block-events")
        );
