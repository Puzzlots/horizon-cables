...
import me.zombii.horizon.common.wired.network.energy.nodes.EnergyNodeDelay;
import me.zombii.horizon.common.wired.network.energy.nodes.EnergyNodeDiode;

import java.util.Arrays;

public class DelayBlock implements IEnergyBlock {

    public static final Identifier ID = Identifier.of(HorizonCommon.NAMESPACE, "delay");
    ...
    public DelayBlock() {
        ...
        eventGenerator = new BlockEventGenerator(
                ...
                Identifier.of("horizon", "delay-block-events")
        );
...
//        this.modelGenerator.getGroup("base").cuboids.add(collisionCube);
    ...
    public AbstractNode createNode(AbstractNetwork network, IReadBlockPosition pos, BlockState state) {
        return new EnergyNodeDelay(network, pos, state, this);
    }
