...
public class EnergyNodeDiode extends EnergyNode {

    public EnergyNodeDiode() {
        super();
    }

    public EnergyNodeDiode(AbstractNetwork network, IReadBlockPosition pos, BlockState state, INetworkedBlock<?> block) {
